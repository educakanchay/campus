...
$string['email_teacher_attend'] = 'このメールには {$a->fullname} [{$a->date}] の出欠データが添付されています．';
$string['email_teacher_key']    = '{$a->fullname} [{$a->date}] の出欠キーワードは {$a->key} です．';
$string['email_teacher_key_html'] = '{$a->fullname} [{$a->date}] の出欠キーワードは <strong>{$a->key}</strong> です．';
...
$string['repairdbconfirm'] = 'DBの修復を行いますか？';
$string['repairok'] = '修復する';
$string['dbrepaired'] = 'DBを修復しました';
